...
function CanDualWield()
	...
	return myClass=="DEATHKNIGHT" or myClass=="ROGUE" or myClass=="WARRIOR" or myClass=="SHAMAN" or myClass=="HUNTER"
end
...
["WARLOCK"]=3,
	...
	myspectab=AG_defaultspec[myClass]
	if TalentPointsIn(3)>TalentPointsIn(2) and TalentPointsIn(3)>TalentPointsIn(1) then myspectab=3 end
	if TalentPointsIn(2)>TalentPointsIn(3) and TalentPointsIn(2)>TalentPointsIn(1) then myspectab=2 end
	if TalentPointsIn(1)>TalentPointsIn(2) and TalentPointsIn(1)>TalentPointsIn(3) then myspectab=1 end
	return AG_spectable[myspectab]
end
	...
	AutoGearDefaultWeights = {
		...
		["SHAMAN"] = {
			...
			["Elemental"] = {
				Strength = 0, Agility = 0, Stamina = 0.05, Intellect = 0.26, Spirit = .1,
				Armor = 0.001, Dodge = 0, Parry = 0, Block = 0, Defense = 0,
				SpellPower = 0.6, SpellPenetration = 0.1, Haste = 0.9, Mp5 = 0.1,
...
function GetWeaponType()
	...
	if link then
		...
		local itemID, itemType, itemSubType, itemEquipLoc, icon, itemClassID, itemSubClassID = GetItemInfo(link)
